...
/*
NodoListaInt* EnListar2(NodoABInt* a){
	if (!a) {
...
/*
NodoListaInt* concatenar(NodoListaInt* l1, NodoListaInt* l2) {

	NodoListaInt* retorno = clon(l1);
	while (retorno->sig) {
		retorno->sig = retorno->sig->sig;
	}
	retorno->sig = l2;
	return retorno;
}
